...
const products = ref([
  ...
  { id: 13, name: 'Taco Callejero', desc: 'Carne asada, guacamole, pico de gallo', fullDesc: 'Tortilla de maíz tostada con carne asada marinada en especias mexicanas, guacamole fresco, pico de gallo casero y salsa verde taquera. Porción de 3 tacos generosos.', highlights: ['Carne marinada en especias', 'Guacamole fresco', 'Pico de gallo casero', 'Porción de 3 tacos'], price: 18900, emoji: '🌮', image: 'https://images.unsplash.com/photo-1551504734-5ee1c4a1479b?w=400&q=80', cat: 'tacos', popular: true },
  { id: 14, name: 'Taco Pollo BBQ', desc: 'Pollo BBQ, maíz, crema, queso', fullDesc: 'Pollo a la parrilla marinado en salsa BBQ artesanal, maíz tostado dulce y ahumado, crema agria fresca, queso fresco rallado en tortilla de maíz artesanal. Porción de 3 tacos.', highlights: ['Pollo BBQ artesanal', 'Maíz tostado ahumado', 'Queso fresco rallado', 'Porción de 3 tacos'], price: 17900, emoji: '🌮', image: 'https://images.unsplash.com/photo-1613514785940-daed07799d9b?w=400&q=80', cat: 'tacos', popular: false },
  ...
  { id: 16, name: 'Pollo Crispy', desc: 'Pechuga apanada, papas, ensalada', fullDesc: 'Pechuga de pollo apanada con mezcla de especias secretas, dorada hasta quedar completamente crujiente. Con papas a la francesa y ensalada coleslaw casera.', highlights: ['Apanado con especias secretas', 'Dorado y crujiente', 'Coleslaw casero', 'Papas incluidas'], price: 18900, emoji: '🍗', image: 'https://images.unsplash.com/photo-1562967914-608f82629710?w=400&q=80', cat: 'pollo', popular: false },
